...
// угол в пределах от 0 до 2PI
        angle = new Double (Math.random()*2*Math.PI).intValue();
...
// и просто выходим (завершаемся)
    ...
    public void paint(Graphics2D canvas) {
        ...
        Rectangle ball = new Rectangle((int)(x-radius), (int)(y-radius), (int)(2*radius), 2*radius );
        canvas.draw(ball);
        canvas.fill(ball);
    }
    ...
    public void paused90(boolean paused)
    {
        this.paused = paused;
        speedX = 0;
        speedY = 0;
